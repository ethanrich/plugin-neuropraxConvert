## Copyright (C) 1994-2017 John W. Eaton <jwe@octave.org>
##
...
function yiq = rgb2ntsc (rgb)
  ...
  [rgb, cls, sz, is_im, is_nd, is_int] ...
    = colorspace_conversion_input_check ("rgb2ntsc", "RGB", rgb, false);
  ...
  yiq = colorspace_conversion_revert (yiq, cls, sz, is_im, is_nd, false);
