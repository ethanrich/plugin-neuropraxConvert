...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "/scratch/build/mxe-octave-w64/release/usr/bin/lrelease")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "/scratch/build/mxe-octave-w64/release/usr/bin/lupdate")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "/scratch/build/mxe-octave-w64/release/usr/bin/lconvert")
    _qt5_LinguistTools_check_file_exists(${imported_location})
