...
#define RSB_HEADER_VERSION_STRING		"librsb version 1.2.0.11 - 202112161631"	/*!< \brief Library header version string. */
...
#define RSB_LIBRSB_VER_DATE		202112161631	/*!< \brief Version release date. */
