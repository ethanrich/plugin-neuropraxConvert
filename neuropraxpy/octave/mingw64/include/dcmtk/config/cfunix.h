...
#define DCMTK_PREFIX "/scratch/build/mxe-octave-w64/release/usr/x86_64-w64-mingw32"

/* Define the default data dictionary path for the dcmdata library package. */
#define DCM_DICT_DEFAULT_PATH "/scratch/build/mxe-octave-w64/release/usr/x86_64-w64-mingw32/share/dicom.dic"

/* Define the default directory where configuration files reside. */
#define DEFAULT_CONFIGURATION_DIR "/scratch/build/mxe-octave-w64/release/usr/x86_64-w64-mingw32/etc/"

/* Define the default directory where support data files reside. */
#define DEFAULT_SUPPORT_DATA_DIR "/scratch/build/mxe-octave-w64/release/usr/x86_64-w64-mingw32/share/"
