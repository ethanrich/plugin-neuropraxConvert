...
#define GDCM_SOURCE_DIR "/scratch/build/mxe-octave-w64/release/tmp-gdcm/gdcm-3.0.10"
#define GDCM_EXECUTABLE_OUTPUT_PATH "/scratch/build/mxe-octave-w64/release/tmp-gdcm/.build/bin"
#define GDCM_LIBRARY_OUTPUT_PATH    "/scratch/build/mxe-octave-w64/release/tmp-gdcm/.build/bin"
...
#define GDCM_CMAKE_INSTALL_PREFIX "/scratch/build/mxe-octave-w64/release/usr/x86_64-w64-mingw32"
